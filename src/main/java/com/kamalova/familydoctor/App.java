...
public class App {
    ...
    private static Map<String, String> timeMessage() {
        ...
        map.put("0 15 8 ? * MON-FRI *", "");
        map.put("0 0 10 ? * MON-FRI *", "");
        map.put("0 0 11 ? * MON-FRI *", "");
        map.put("0 0 12 ? * MON-FRI *", "");
        map.put("0 0 16 ? * MON-FRI *", "");
        map.put("0 0 18 ? * MON-FRI *", "");
        map.put("0 0 21 ? * MON-FRI *", "");
        return map;
    }
}
